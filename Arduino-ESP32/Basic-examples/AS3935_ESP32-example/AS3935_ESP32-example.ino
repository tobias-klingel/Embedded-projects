...
////####################################################################################################
//AS3935  //Based on: SparkFun Electronics
...
void loop()
{
  ...
  if(digitalRead(lightningInt) == HIGH){
    ...
    if(intVal == NOISE_INT){
      //Serial.println("Noise."); //Can be use for debugging
      noiseCount +=1;
    }
    else if(intVal == DISTURBER_INT){
      //Serial.println("Disturber."); //Can be use for debugging
      disturberCount +=1;
    }
  ...
  //Prints every minute the number of noise and disturber
  if(previousTime + timeDelayForNosieAndDisturberCount < millis()){
    Serial.println("noiseCount_AS3995"+ String(noiseCount)); 
    Serial.println("disturberCount_AS3995" + String(disturberCount)); 
    noiseCount = 0;
    disturberCount = 0;
